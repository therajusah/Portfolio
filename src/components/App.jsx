...
function App() {
  ...
  <div className="container mx-auto px-4 md:px-10">
    <div className="flex flex-col md:flex-row justify-center items-center">
      ...
      <div className="md:w-1/2 px-4 md:px-10 mt-8 md:mt-0" ref={textDivRef}>
        <h3 className="text-white text-3xl md:text-5xl">Hey,</h3>
        <h3 className="text-white text-3xl md:text-5xl">I am Raju Kumar</h3>
        <p className="text-white text-xl md:text-2xl">A Frontend developer</p>
        <a
          href="#contact"
